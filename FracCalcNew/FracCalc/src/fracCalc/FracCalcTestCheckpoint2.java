...
public class FracCalcTestCheckpoint2
{
    ...
    @Test public void testCheckpoint2_3() {  FracCalcTestALL.assertForEarlyCheckpoints(null, "whole:1 numerator:2 denominator:7", "-33_2/7", FracCalc.produceAnswer("-32 - 27/21"));}
